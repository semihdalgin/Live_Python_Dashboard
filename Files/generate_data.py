...
first_name_options = ['Bridie', 'Bryson', 'Reginald', 'Daanyal', 'Aeryn', 'Nettie', 'Dawn', 'Katelyn', 'Mujtaba',
                      'Stan']
last_name_options = ['Lucas', 'Tait', 'Maxwell', 'Levine', 'Hook', 'Mcgregor', 'Stephenson', 'Lord', 'Delgado',
                     'Barnett']
profession_options = ['Professional athlete', 'Massage Therapist', 'Secretary', 'High School Teacher',
                      'Environmental scientist', 'Social Worker', 'Accountant', 'Epidemiologist',
                      'Market Research Analyst', 'Dentist', 'Construction Manager', 'Substance Abuse Counselor']
...
for i in range(nr_rows):
    ...
    random_email = random_first_name.lower() + "." + random_last_name.lower() + str(
        random.choice(range(100))) + random.choice(email_domain_options)
