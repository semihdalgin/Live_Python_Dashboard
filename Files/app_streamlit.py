...
with col2:
    st.markdown("<h5 style='text-align: center; color: black;'>Average salary per profession</h1>",
                unsafe_allow_html=True)
    st.bar_chart(relate_data(data, 'Profession', 'Salary'))

with col3:
    st.markdown("<h5 style='text-align: center; color: black;'>Average salary per age group</h1>",
                unsafe_allow_html=True)
...
with col2:
    st.markdown("<h5 style='text-align: center; color: black;'>Accumulated signups over time</h1>",
                unsafe_allow_html=True)
